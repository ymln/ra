...
(def large-wbs-tasks
;;;id name                                                         time             finances            quality              deps
  [[1 "Network OS Extended Addressing Project (and Survey Packet)" [10 15 17 13 15] [100 99 99 100 100] [98 80 81 89 70] [2 74 118 279 280 283 286 288]]
   [2 "Phase 1 -- Kickoff" [2 6 3 4 2] [334 300 300 299 300] [78 73 72 91 91] [3 11 16 22 26 29 32 37 42 52 55 60 64 69]]
   ...
   [9 "Document Critical test results" [4 8 5 9 9] [548 451 593 541 438] [29 28 37 23 82] [8]]
   [10 "Evaluate Preliminary Critical test results" [2 3 4 3 4] [789 746 662 830 645] [20 79 81 21 19] [9]]
   ...
   [13 "Review first draft of schedule" [2 2 5 3 4] [423 388 427 429 467] [13 97 89 82 51] [12]]
   [14 "Schedule update" [2 4 5 3 2] [843 986 964 965 708] [86 79 91 97 73] [13]]
   [15 "First draft of schedule complete" [0 0 0 0 0] [438 371 498 516 403] [87 73 96 77 92] [14]]
   [16 "Project Vision" [1 2 2 3 2] [289 295 286 346 280] [64 46 65 56 96] [17 18 19 20 21]]
   [17 "Initial Draft of Vision" [4 5 4 5 6] [842 778 910 942 960] [98 83 98 10 97] [15]]
   [18 "1st Round of Team Reviews" [2 4 2 4 2] [836 834 935 688 711] [89 77 89 18 79] [17]]
   [19 "Ongoing Vision Updates" [4 4 6 5 4] [324 306 313 287 296] [45 39 41 50 47] [18]]
   [20 "Final Round of Team Review" [4 5 4 6 8] [489 541 405 559 494] [38 47 92 64 83] [19]]
   [21 "Project Vision Complete" [0 0 0 0 0] [238 932 328 82 982] [18 16 21 19 16] [20]]
   [22 "Team Roles List" [0 0 0 0 0] [382 289 732 732 739] [58 75 75 96 35] [23 24 25]]
   ...
   [25 "Team Roles List Complete" [0 0 0 0 0] [849 712 974 882 975] [93 80 92 89 93] [24]]
   ...
   [29 "Team Responsibility Matrix" [1 2 1 2 1] [843 731 710 714 841] [97 99 88 72 81] [30 31]]
   ...
   [32 "Architectural Specification" [1 3 2 1 2] [732 711 722 747 863] [90 84 87 86 96] [33 34 35 36]]
   ...
   [39 "Review Risk Assessment List" [1 2 2 2 1] [832 916 959 921 892] [94 94 72 81 94] [38]]
   [40 "Update Risk Assessment List" [1 2 2 2 1] [832 865 961 998 875] [92 78 76 88 93] [39]]
   [41 "Product Innovation Risk Assessment Complete" [0 0 0 0 0] [445 439 360 493 480] [97 95 97 86 86] [40]]
   ...
   [56 "Write Preliminary System VerificationTest Plan" [4 5 4 4 4] [210 189 179 779 165] [91 79 96 78 98] [18 45 51]]
   ...
   [66 "Review List of Tools and Equipment" [0 0 0 0 0] [400 412 440 473 376] [96 88 92 93 72] [65]]
   ...
   [69 "Critical Issues List and Contingency Plans" [1 1 1 1 1] [233 251 207 284 223] [98 83 84 84 16] [70 71 72 73]]
   ...
   [74 "Phase 2 -- Design" [3 4 4 3 3] [285 350 357 348 291] [57 67 47 63 48] [75 81 91 106 110 114]]
   ...
   [118 "Phase 3 -- Development" [2 3 3 3 2] [175 123 106 127 118] [34 39 30 39 35] [119 122 126 132 138 154 159 166 172 173 179 218 239 242 245 276]]
   [119 "SQA Regression Test Plan" [2 2 2 2 3] [264 297 219 354 286] [99 89 82 81 89] [120 121]]
   ...
   [122 "Alpha Test Plan" [2 2 2 2 2] [176 190 165 190 153] [98 95 85 17 94] [123 124 125]]
   ...
   [133 "Modify RouterProtocol library" [5 5 7 7 5] [195 116 101 106 135] [99 92 17 10 10] [80]]
   ...
   [166 "Upgrade RouterNetLayer and dependencies" [2 3 2 3 3] [551 540 473 600 658] [93 82 98 87 96] [167 168 169 170 171]]
   ...
   [170 "Update Regression test plan/scripts - Phase 3 (w RouterNetLayer & CellCntrlr)" [2 3 3 3 2] [183 158 167 110 127] [99 89 90 84 84] [169 121]]
   ...
   [249 "MgmtAPI Design Spec Update" [0 0 0 0 0] [85 95 87 89 81] [10 20 30 40 50] [248]]
   ...
   [252 "MgmtAPI Code Review" [2 2 2 3 2] [104 110 128 184 190] [95 86 19 88 15] [250]]
   [253 "MgmtAPI Code Update" [1 1 2 1 2] [242 220 295 262 235] [97 97 14 86 12] [251]]
   ...
   [258 "RouterNetLayer Spec Review" [1 1 1 1 2] [183 134 114 139 150] [89 90 82 79 83] [256]]
   ...
   [280 "Phase 4 -- Alpha Testing" [1 2 2 1 2] [166 157 113 140 152] [66 69 59 60 66] [281 282]]
   ...
   [283 "Phase 5 -- Beta Testing" [2 16 24 25 20] [942 104 916 756 950] [29 34 33 25 29] [284 285]]
   ...
   [286 "Phase 6 -- Release" [3 4 3 4 4] [111 150 149 144 104] [40 34 39 43 40] [287]]
...
(defn large-wbs-ra-run []
  (let [w (repeat 288 1)]
    (ra w large-wbs-tasks 70000 300)))

(deftest large-wbs-tasks-test
  (let [sol (ra large-wbs-tasks-w large-wbs-tasks 70000 300)]
    (is (= (dissoc sol :x) {:quality 142210
                            :finances 69766
                            :time 220}))))

#_(doseq [dep deps] (doseq [parent (second dep)] (println parent "->" (first dep) ";")))

#_(do
(def colors {-1 "white" 0 "white" 1 "red" 2 "green" 3 "blue" 4 "orange"})
(def inds (map-indexed (fn [n x] [(inc n) (.indexOf x 1)]) (:x sol)))
(def colrs (map (fn [[n ind]] [n (colors ind)]) inds))
(doseq [[n colr] colrs] (println n "[fillcolor=" colr ",style=filled];"))
    )